...
switch($_GET[act]){
  ...
  case "tambahberita":
    ...
    echo "</select></td></tr>
          <tr><td>Isi Berita</td><td> : <textarea name='isi_berita' cols=55 rows=10></textarea></td></tr>
  ...
  case "editberita":
    ...
    echo "</select></td></tr>
          <tr><td>Isi Berita</td><td> : <textarea name='isi_berita' cols=55 rows=10>$r[isi_berita]</textarea></td></tr>
